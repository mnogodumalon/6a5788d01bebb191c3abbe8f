...
const PROXY_BASE = '';
const APP_ID = '6a5788bbc6266be51ca40b60';
...
export default function PublicFormPersonenpunkte() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Personenpunkte — Formular</h1>
        </div>
